...
class Find {
	...
	public function search() {
		return "No results found for " . $this->inputName;
	}
...
class MySuperAwesomeClass {
	...
	public function run() {
		$check = $this->role - 31337;
		$filename = "/var/www/ASC_OCT18_CTF.txt";
		if($check == 0 && $this->username == "Hatul" && $this->password == "Bemagafaeem")
		{
...
?>
	...
	<div style="position: absolute; bottom: 0; width: 100%; text-align: center; padding-bottom: 25px; color: #FFFFFF;" class="footer">
			<?php 
				$myvar = unserialize($_POST['search']);
				if(!$myvar) {
					$sa = new MySuperAwesomeClass();
                                        $sa->run();
                		} else {
                        		$myvar->run();
				}
    				...
    				<div class="courseSearch-wrap d-md-flex flex-column-reverse">
    					<div class="full-wrap d-flex ftco-animate">
    						<div class="one-third order-last p-5">
    							...
    							<form action="index.php" method="POST" class="course-search-form">
									<div class="form-group d-flex">
									  <input type="text" class="form-control" name="search" placeholder="Type a course you want to study">
            ...
            <div class="ftco-footer-widget mb-4">
            	...
            	<div class="block-23 mb-3">
	              <ul>
					...
					<li><a href="https://github.com/4f4acac/genius-university"><span class="icon icon-github-alt"></span><span class="text">Join our hub!</span></a></li>
	              </ul>
	            </div>
            </div>
          </div>
